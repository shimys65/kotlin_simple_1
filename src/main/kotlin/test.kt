...
/*
{
    ...
    val fileContent = readStrFromFile("test/3.json") //File("test/3.json").readText(Charsets.UTF_8)
...
fun testWriteFile3() {
    ...
    writeStrFile("test/3.json", testArticle.toJson()) //File("test/3.json").writeText(testArticle.toJson())
}
